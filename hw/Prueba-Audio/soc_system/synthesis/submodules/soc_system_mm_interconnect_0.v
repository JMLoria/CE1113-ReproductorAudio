...
module soc_system_mm_interconnect_0 (
		...
		output wire [1:0]  audio_config_external_avalon_av_config_slave_address,     // audio_config_external_avalon_av_config_slave.address
		output wire        audio_config_external_avalon_av_config_slave_write,       //                                             .write
		output wire        audio_config_external_avalon_av_config_slave_read,        //                                             .read
		input  wire [31:0] audio_config_external_avalon_av_config_slave_readdata,    //                                             .readdata
		output wire [31:0] audio_config_external_avalon_av_config_slave_writedata,   //                                             .writedata
		output wire [3:0]  audio_config_external_avalon_av_config_slave_byteenable,  //                                             .byteenable
		input  wire        audio_config_external_avalon_av_config_slave_waitrequest, //                                             .waitrequest
	...
	wire  [31:0] audio_config_external_avalon_av_config_slave_agent_m0_readdata;                // audio_config_external_avalon_av_config_slave_translator:uav_readdata -> audio_config_external_avalon_av_config_slave_agent:m0_readdata
	wire         audio_config_external_avalon_av_config_slave_agent_m0_waitrequest;             // audio_config_external_avalon_av_config_slave_translator:uav_waitrequest -> audio_config_external_avalon_av_config_slave_agent:m0_waitrequest
	wire         audio_config_external_avalon_av_config_slave_agent_m0_debugaccess;             // audio_config_external_avalon_av_config_slave_agent:m0_debugaccess -> audio_config_external_avalon_av_config_slave_translator:uav_debugaccess
	wire  [16:0] audio_config_external_avalon_av_config_slave_agent_m0_address;                 // audio_config_external_avalon_av_config_slave_agent:m0_address -> audio_config_external_avalon_av_config_slave_translator:uav_address
	wire   [3:0] audio_config_external_avalon_av_config_slave_agent_m0_byteenable;              // audio_config_external_avalon_av_config_slave_agent:m0_byteenable -> audio_config_external_avalon_av_config_slave_translator:uav_byteenable
	wire         audio_config_external_avalon_av_config_slave_agent_m0_read;                    // audio_config_external_avalon_av_config_slave_agent:m0_read -> audio_config_external_avalon_av_config_slave_translator:uav_read
	wire         audio_config_external_avalon_av_config_slave_agent_m0_readdatavalid;           // audio_config_external_avalon_av_config_slave_translator:uav_readdatavalid -> audio_config_external_avalon_av_config_slave_agent:m0_readdatavalid
	wire         audio_config_external_avalon_av_config_slave_agent_m0_lock;                    // audio_config_external_avalon_av_config_slave_agent:m0_lock -> audio_config_external_avalon_av_config_slave_translator:uav_lock
	wire  [31:0] audio_config_external_avalon_av_config_slave_agent_m0_writedata;               // audio_config_external_avalon_av_config_slave_agent:m0_writedata -> audio_config_external_avalon_av_config_slave_translator:uav_writedata
	wire         audio_config_external_avalon_av_config_slave_agent_m0_write;                   // audio_config_external_avalon_av_config_slave_agent:m0_write -> audio_config_external_avalon_av_config_slave_translator:uav_write
	wire   [2:0] audio_config_external_avalon_av_config_slave_agent_m0_burstcount;              // audio_config_external_avalon_av_config_slave_agent:m0_burstcount -> audio_config_external_avalon_av_config_slave_translator:uav_burstcount
	wire         audio_config_external_avalon_av_config_slave_agent_rf_source_valid;            // audio_config_external_avalon_av_config_slave_agent:rf_source_valid -> audio_config_external_avalon_av_config_slave_agent_rsp_fifo:in_valid
	wire  [93:0] audio_config_external_avalon_av_config_slave_agent_rf_source_data;             // audio_config_external_avalon_av_config_slave_agent:rf_source_data -> audio_config_external_avalon_av_config_slave_agent_rsp_fifo:in_data
	wire         audio_config_external_avalon_av_config_slave_agent_rf_source_ready;            // audio_config_external_avalon_av_config_slave_agent_rsp_fifo:in_ready -> audio_config_external_avalon_av_config_slave_agent:rf_source_ready
	wire         audio_config_external_avalon_av_config_slave_agent_rf_source_startofpacket;    // audio_config_external_avalon_av_config_slave_agent:rf_source_startofpacket -> audio_config_external_avalon_av_config_slave_agent_rsp_fifo:in_startofpacket
	wire         audio_config_external_avalon_av_config_slave_agent_rf_source_endofpacket;      // audio_config_external_avalon_av_config_slave_agent:rf_source_endofpacket -> audio_config_external_avalon_av_config_slave_agent_rsp_fifo:in_endofpacket
	wire         audio_config_external_avalon_av_config_slave_agent_rsp_fifo_out_valid;         // audio_config_external_avalon_av_config_slave_agent_rsp_fifo:out_valid -> audio_config_external_avalon_av_config_slave_agent:rf_sink_valid
	wire  [93:0] audio_config_external_avalon_av_config_slave_agent_rsp_fifo_out_data;          // audio_config_external_avalon_av_config_slave_agent_rsp_fifo:out_data -> audio_config_external_avalon_av_config_slave_agent:rf_sink_data
	wire         audio_config_external_avalon_av_config_slave_agent_rsp_fifo_out_ready;         // audio_config_external_avalon_av_config_slave_agent:rf_sink_ready -> audio_config_external_avalon_av_config_slave_agent_rsp_fifo:out_ready
	wire         audio_config_external_avalon_av_config_slave_agent_rsp_fifo_out_startofpacket; // audio_config_external_avalon_av_config_slave_agent_rsp_fifo:out_startofpacket -> audio_config_external_avalon_av_config_slave_agent:rf_sink_startofpacket
	wire         audio_config_external_avalon_av_config_slave_agent_rsp_fifo_out_endofpacket;   // audio_config_external_avalon_av_config_slave_agent_rsp_fifo:out_endofpacket -> audio_config_external_avalon_av_config_slave_agent:rf_sink_endofpacket
	wire         cmd_mux_src_valid;                                                             // cmd_mux:src_valid -> audio_config_external_avalon_av_config_slave_agent:cp_valid
	wire  [92:0] cmd_mux_src_data;                                                              // cmd_mux:src_data -> audio_config_external_avalon_av_config_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                             // audio_config_external_avalon_av_config_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [4:0] cmd_mux_src_channel;                                                           // cmd_mux:src_channel -> audio_config_external_avalon_av_config_slave_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                     // cmd_mux:src_startofpacket -> audio_config_external_avalon_av_config_slave_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                       // cmd_mux:src_endofpacket -> audio_config_external_avalon_av_config_slave_agent:cp_endofpacket
	...
	wire  [92:0] cmd_mux_003_src_data;                                                          // cmd_mux_003:src_data -> nios2_debug_mem_slave_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                         // nios2_debug_mem_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                       // cmd_mux_003:src_channel -> nios2_debug_mem_slave_agent:cp_channel
	...
	wire         audio_config_external_avalon_av_config_slave_agent_rp_valid;                   // audio_config_external_avalon_av_config_slave_agent:rp_valid -> router_002:sink_valid
	wire  [92:0] audio_config_external_avalon_av_config_slave_agent_rp_data;                    // audio_config_external_avalon_av_config_slave_agent:rp_data -> router_002:sink_data
	wire         audio_config_external_avalon_av_config_slave_agent_rp_ready;                   // router_002:sink_ready -> audio_config_external_avalon_av_config_slave_agent:rp_ready
	wire         audio_config_external_avalon_av_config_slave_agent_rp_startofpacket;           // audio_config_external_avalon_av_config_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         audio_config_external_avalon_av_config_slave_agent_rp_endofpacket;             // audio_config_external_avalon_av_config_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire  [92:0] nios2_debug_mem_slave_agent_rp_data;                                           // nios2_debug_mem_slave_agent:rp_data -> router_005:sink_data
	...
	wire         audio_config_external_avalon_av_config_slave_agent_rdata_fifo_src_valid;       // audio_config_external_avalon_av_config_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] audio_config_external_avalon_av_config_slave_agent_rdata_fifo_src_data;        // audio_config_external_avalon_av_config_slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         audio_config_external_avalon_av_config_slave_agent_rdata_fifo_src_ready;       // avalon_st_adapter:in_0_ready -> audio_config_external_avalon_av_config_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                                 // avalon_st_adapter:out_0_valid -> audio_config_external_avalon_av_config_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                                  // avalon_st_adapter:out_0_data -> audio_config_external_avalon_av_config_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                                 // audio_config_external_avalon_av_config_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                                 // avalon_st_adapter:out_0_error -> audio_config_external_avalon_av_config_slave_agent:rdata_fifo_sink_error
	...
	) audio_config_external_avalon_av_config_slave_translator (
		.clk                    (clk_0_clk_clk),                                                       //                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset),                             //                    reset.reset
		.uav_address            (audio_config_external_avalon_av_config_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (audio_config_external_avalon_av_config_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (audio_config_external_avalon_av_config_slave_agent_m0_read),          //                         .read
		.uav_write              (audio_config_external_avalon_av_config_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (audio_config_external_avalon_av_config_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (audio_config_external_avalon_av_config_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (audio_config_external_avalon_av_config_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (audio_config_external_avalon_av_config_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (audio_config_external_avalon_av_config_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (audio_config_external_avalon_av_config_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (audio_config_external_avalon_av_config_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (audio_config_external_avalon_av_config_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (audio_config_external_avalon_av_config_slave_write),                  //                         .write
		.av_read                (audio_config_external_avalon_av_config_slave_read),                   //                         .read
		.av_readdata            (audio_config_external_avalon_av_config_slave_readdata),               //                         .readdata
		.av_writedata           (audio_config_external_avalon_av_config_slave_writedata),              //                         .writedata
		.av_byteenable          (audio_config_external_avalon_av_config_slave_byteenable),             //                         .byteenable
		.av_waitrequest         (audio_config_external_avalon_av_config_slave_waitrequest),            //                         .waitrequest
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) audio_config_external_avalon_av_config_slave_agent (
		.clk                     (clk_0_clk_clk),                                                                 //             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),                                       //       clk_reset.reset
		.m0_address              (audio_config_external_avalon_av_config_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (audio_config_external_avalon_av_config_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (audio_config_external_avalon_av_config_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (audio_config_external_avalon_av_config_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (audio_config_external_avalon_av_config_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (audio_config_external_avalon_av_config_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (audio_config_external_avalon_av_config_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (audio_config_external_avalon_av_config_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (audio_config_external_avalon_av_config_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (audio_config_external_avalon_av_config_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (audio_config_external_avalon_av_config_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (audio_config_external_avalon_av_config_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (audio_config_external_avalon_av_config_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (audio_config_external_avalon_av_config_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (audio_config_external_avalon_av_config_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (audio_config_external_avalon_av_config_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (audio_config_external_avalon_av_config_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (audio_config_external_avalon_av_config_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (audio_config_external_avalon_av_config_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (audio_config_external_avalon_av_config_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (audio_config_external_avalon_av_config_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (audio_config_external_avalon_av_config_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (audio_config_external_avalon_av_config_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (audio_config_external_avalon_av_config_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (audio_config_external_avalon_av_config_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (audio_config_external_avalon_av_config_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                                                 // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                                                 //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                                                  //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                                                 //                .error
		.rdata_fifo_src_ready    (audio_config_external_avalon_av_config_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (audio_config_external_avalon_av_config_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (audio_config_external_avalon_av_config_slave_agent_rdata_fifo_src_data),        //                .data
	...
	) audio_config_external_avalon_av_config_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                                                 //       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),                                       // clk_reset.reset
		.in_data           (audio_config_external_avalon_av_config_slave_agent_rf_source_data),             //        in.data
		.in_valid          (audio_config_external_avalon_av_config_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (audio_config_external_avalon_av_config_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (audio_config_external_avalon_av_config_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (audio_config_external_avalon_av_config_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (audio_config_external_avalon_av_config_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (audio_config_external_avalon_av_config_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (audio_config_external_avalon_av_config_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (audio_config_external_avalon_av_config_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (audio_config_external_avalon_av_config_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	soc_system_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (audio_config_external_avalon_av_config_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (audio_config_external_avalon_av_config_slave_agent_rp_valid),         //          .valid
		.sink_data          (audio_config_external_avalon_av_config_slave_agent_rp_data),          //          .data
		.sink_startofpacket (audio_config_external_avalon_av_config_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (audio_config_external_avalon_av_config_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                                       //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset),                             // clk_reset.reset
	...
	soc_system_mm_interconnect_0_cmd_demux_001 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (audio_config_external_avalon_av_config_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (audio_config_external_avalon_av_config_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (audio_config_external_avalon_av_config_slave_agent_rdata_fifo_src_ready), //         .ready
